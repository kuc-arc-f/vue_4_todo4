<template>
    <div>
        ...
        <tr>
            ...
            <td>
                <h4>
                <router-link :to="'/todos/show/' + blog._id">{{ blog.title }}</router-link>
                </h4>
            </td>
            <td>{{ blog.date_str }}</td>
            <td>&nbsp;<router-link :to="'/todos/edit/' + blog._id" class="btn btn-outline-primary"> edit </router-link>
            </td>
        </tr>
        </tbody>
        </table>
